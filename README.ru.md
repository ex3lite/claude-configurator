...
- Отдельное управление подписью Claude в коммитах, pull request и ссылками на сессию.
...
В разделе **Поведение** доступны три актуальные
[настройки атрибуции Claude Code](https://code.claude.com/docs/en/settings#attribution-settings).
Выберите **Скрыто** для коммитов и pull request, затем выключите ссылку на
сессию — это уберёт все встроенные подписи:
...
Пункт **По умолчанию / наследовать** удаляет выбранный ключ и возвращает
наследование. Устаревший `includeCoAuthoredBy` конфигуратор не записывает.

![Настройка подписи в коммитах](docs/screenshots/ru/tui-attribution.png)
