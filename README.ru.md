...
В picker доступны стабильные алиасы Claude Code: `default`, `best`, `sonnet`,
`opus`, `haiku`, варианты с контекстом 1M и `opusplan`. Последний пункт
**Другая модель…** оставлен только для gateway и provider-конфигураций; обычный
выбор модели больше не открывает строковое поле. Подробнее — в
