...
var Specs = []Spec{
	{ID: "main-model", Path: "model", Label: "Main model", Category: "Models", Kind: String, Options: []string{"default", "fable", "opus", "sonnet", "haiku"}, Description: "Default model for new Claude Code sessions. Aliases and custom provider model IDs are accepted."},
	{ID: "subagent-model", Path: "env.CLAUDE_CODE_SUBAGENT_MODEL", Label: "Subagent model", Category: "Models", Kind: String, Options: []string{"inherit", "fable", "opus", "sonnet", "haiku"}, Description: "Model for all subagents, agent teams, and workflow agents. Overrides per-agent model choices."},
	{ID: "advisor-model", Path: "advisorModel", Label: "Advisor model", Category: "Models", Kind: String, Options: []string{"fable", "opus", "sonnet"}, Description: "Model used by the server-side advisor tool."},
	{ID: "fallback-models", Path: "fallbackModel", Label: "Fallback models", Category: "Models", Kind: List, MaxItems: 3, Description: "Ordered fallback chain. Claude Code accepts up to three unique aliases or model IDs."},
	...
	{ID: "language", Path: "language", Label: "Response language", Category: "Interface", Kind: String, Description: "Preferred language for responses, dictation, and terminal session titles."},
