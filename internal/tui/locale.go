...
var translations = map[uiLanguage]map[string]string{
	...
	languageRU: {
		...
		"spec.statusline-theme.description":    "Панель над footer: модель, проект, Git, остаток контекста, лимиты 5h/7d и время до сброса.",
		...
		"spec.statusline-theme.purpose":    "Показывает реальные лимиты и countdown без парсинга экрана. Тема с иконками появляется автоматически, если установлен Nerd Font.",
	...
	languageZH: {
		...
		"spec.statusline-theme.description":    "输入区上方显示模型、项目、Git、剩余上下文、5h/7d 限制和重置倒计时。",
		...
		"spec.statusline-theme.purpose":    "无需解析终端即可显示真实限制和倒计时；安装 Nerd Font 后会自动解锁图标主题。",
