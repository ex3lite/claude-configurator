...
var translations = map[uiLanguage]map[string]string{
	...
	languageRU: {
		...
		"spec.statusline-theme.purpose":    "Показывает реальные лимиты и countdown без парсинга экрана; можно выбрать палитру Claude, ANSI, монохром или свою команду.",
	...
	languageZH: {
		...
		"spec.statusline-theme.purpose":    "无需解析终端即可显示真实限制和倒计时；支持 Claude、ANSI、单色或自定义命令。",
